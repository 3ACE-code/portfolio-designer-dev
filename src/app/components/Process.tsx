  ...
  return (
    <section className="py-20 sm:py-24 bg-white relative">
      <div className="container mx-auto px-5 md:px-10 xl:px-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-12 max-w-5xl mx-auto relative">
          ...
          {steps.map((step, idx) => (
            <motion.div
              ...
              transition={shouldReduceMotion ? undefined : { delay: step.delay, duration: 0.5 }}
              className="flex flex-col items-center text-center"
            >
              <div className="w-20 h-20 sm:w-24 sm:h-24 bg-white rounded-full flex items-center justify-center shadow-[0_10px_40px_rgba(0,0,0,0.06)] border border-zinc-100 mb-6 relative">
                <div className={`absolute inset-0 border border-zinc-200 rounded-full border-dashed ${shouldReduceMotion ? "" : "animate-[spin_10s_linear_infinite]"}`}></div>
                {step.icon}
