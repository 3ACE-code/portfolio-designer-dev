...
export function About() {
  ...
  return (
    <section className="bg-white min-h-screen flex items-center pt-28 sm:pt-32 pb-20 sm:pb-24 overflow-hidden selection:bg-[#00F0FF] selection:text-black">
      <div className="container mx-auto px-5 md:px-10 xl:px-12 grid grid-cols-1 lg:grid-cols-2 gap-14 lg:gap-24 items-center max-w-7xl">
        ...
        >
          <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-extrabold text-zinc-900 mb-8 leading-[1.1] tracking-tight">
            Precyzja designu.<br />
